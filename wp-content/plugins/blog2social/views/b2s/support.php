                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills b2s-support-menu">
                            <li class="active">
                                <a href="#b2s-support-faq" class="b2s-support-faq" data-toggle="tab"><?php _e('FAQ', 'blog2social') ?></a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="b2s-support-faq">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <form action="<?php echo B2S_Tools::getSupportLink('faq_direct'); ?>" method="GET" target="_blank">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon btn-primary b2s-color-white b2s-text-bold hidden-xs"><?php _e('Search all support', 'blog2social') ?></span>
                                                    <input type="text" name="search" placeholder="<?php _e('Entry keyword or ask a question', 'blog2social') ?>" class="form-control">
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <h3><?php _e('Support Topics', 'blog2social') ?></h3>
                                            <br>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_installation'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Installation', 'blog2social') ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_network'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Connecting Social Networks', 'blog2social') ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_sharing'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Autoposting, Sharing und Re-Sharing', 'blog2social') ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_customize'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Customizing Social Media Posts', 'blog2social') ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_scheduling'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Scheduling and Best Time Manager', 'blog2social') ?></a>
                                                            </div>
                                                        </div></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_licence'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Contracting and Licensing', 'blog2social') ?></a>
                                                            </div>
                                                        </div></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_troubleshooting'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Troubleshooting for Error Messages', 'blog2social') ?></a>
                                                            </div>
                                                        </div></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="media">
                                                        ...
                                                        <div class="col-md-11 del-padding-left">
                                                            <div class="media-body">
                                                                <a href="<?php echo B2S_Tools::getSupportLink('faq_settings'); ?>" class="btn btn-link btn-lg b2s-color-black"target="_blank"><?php _e('Helpful Network Settings', 'blog2social') ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <h3><?php _e('TOP FAQs', 'blog2social') ?></h3>
                                        ...
                                        <div class="col-md-12">
                                            <?php if (B2S_PLUGIN_USER_VERSION > 0) { ?>
                                                ...
                                                <span class="btn btn-default b2s-dashoard-btn-phone"><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> <?php _e('Call us: +49 2181 7569-277', 'blog2social') ?></span>
                                                <br>
                                                <div class="b2s-info-sm"><?php _e('(Support times: from 9:00 a.m. to 5:00 p.m. CET on working days)', 'blog2social') ?></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="b2s-support-check-system">
                                ...
                                <div class="row width-100" id="b2s-support-no-admin" style="display: none;">
                                    <div class="text-center b2s-text-bold"><?php _e("You need admin rights to use the Troubleshooting-Tool. Please contact your administrator.", "blog2social"); ?></div>
                                </div>
                                <div id="b2s-main-debug" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <h4><?php _e("Needed", "blog2social"); ?></h4>
                                        </div>
                                        <div class="col-sm-2">
                                            <h4><?php _e("Current", "blog2social"); ?></h4>
                                        </div>
                                        <div class="col-sm-3">
                                            <button id="b2s-reload-debug-btn" class="btn btn-primary pull-right margin-right-15 b2s-margin-left-10" title="<?php _e("reload", "blog2social"); ?>"><i class="glyphicon glyphicon-refresh"></i></button>
                                            <a class="btn btn-primary pull-right b2s-support-link-not-active" title="<?php _e("Export as txt-file", "blog2social"); ?>" id="b2s-debug-export" download="blog2social-support.txt"><i class="glyphicon glyphicon-download-alt"></i></a>
                                        </div>
                                    </div>
                                    <br>
                                    <hr>
