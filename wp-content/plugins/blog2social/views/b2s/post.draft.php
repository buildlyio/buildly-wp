    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e('Delete Social Media Draft', 'blog2social') ?></h4>
            </div>
            <div class="modal-body">
                <b><?php _e('Are you sure you want to delete this Social Media draft?', 'blog2social') ?> </b>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-danger b2s-draft-delete-confirm-btn"><?php _e('YES, delete', 'blog2social') ?></button>
            </div>
        </div>
    </div>
</div>
