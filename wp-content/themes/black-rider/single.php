                ...
                <div class="grid_16 alpha">
                    <div class="content-bar">
                        ...
                        <nav id="nav-single"> <span class="nav-previous">
                                <?php previous_post_link('%link', __('<span class="meta-nav">&larr;</span> Previous Post ', 'black-rider')); ?>
                            </span> <span class="nav-next">
                                 <?php next_post_link('%link', __('Next Post <span class="meta-nav">&rarr;</span>', 'black-rider')); ?>
                            </span> </nav>
